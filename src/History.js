    ...
    <div className="bg-black min-vh-100 text-white py-5">
      <Container>
        ...
        {loading ? (
          ...
          <Row className="g-4">
            {tickets.map((t) => {
              const ticketType = t.ticketType || t.TicketType || "Regular";
                        ...
                        <Card.Body className="d-flex flex-column justify-content-between h-100 bg-secondary bg-opacity-10">
                          <div>
                            <div className="d-flex justify-content-between align-items-start mb-2">
                              <Badge bg={isVip ? "warning" : "info"} text="dark" className="px-2">
                                {isVip ? "VIP PASS" : "REGULAR"}
                              </Badge>
                              <small className="text-warning font-monospace small">
                                #{(t.ticketId || t.TicketId || "000").substring(0, 8)}
                              </small>
                            </div>
                          ...
                          <div className="mt-3 pt-2 border-top border-secondary d-flex justify-content-between align-items-center">
                            <div>
                              ...
                              <span className="fw-bold fs-5 text-warning">${t.price || t.Price}</span>
                            </div>
                            {/* NEW: Ethio Concert text in place of Details button */}
